...
def client():
    """
    Create a TestClient for the FastAPI application used in tests.
    
    Returns:
        TestClient: A requests-compatible client bound to the application's ASGI app for synchronous test requests.
    """
